...
public:
	...
	static GLuint GroundFloor() { return m_GroundFloor; }
	static GLuint ScoreBoardTex() { return m_ScoreBoardTex; }
	static GLuint IO() {return m_IO;}
...
protected:
	...
	static Mesh* m_GFloor;
	static Mesh* m_pPlane;


	static GLuint m_CheckerboardTex;
	static GLuint m_GroundFloor;
	static GLuint m_ScoreBoardTex;
	static GLuint m_IO;
};
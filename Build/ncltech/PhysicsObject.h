...
public:
	...
	inline bool                 RestState()                 const   { return m_Rested; }
	inline bool                 GetCollision()              const   { return m_Collisioned; }
	inline bool                 GetScore()                  const   { return m_getscored; }
	...
	inline void SetRestState(bool rested)                           { m_Rested = rested; }
	inline void SetScored(bool scored)                              { m_getscored = scored; }
	inline void SetCollision(bool collided)                         { m_Collisioned = collided; }
	inline void SetBullet(bool bullets)                             { m_bullet = bullets; }  //score board bullet 
	inline void SetTarget(bool targetboard)                         { m_target = targetboard; }
...
protected:
	...
	bool				m_Enabled;
	bool                m_Rested;     // bool rest and wake-up
	bool                m_bullet;     //score board bullet
	bool                m_target;     //score board target
	bool                m_getpoint;   //score board if
	bool                m_getscored;
	 //target hit point
